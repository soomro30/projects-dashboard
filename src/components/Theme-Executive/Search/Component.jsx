...
class Component extends React.Component {
  ...
  componentDidMount() {
    ...
    document
      .getElementById("headerSearchInputExecutive")
      ?.addEventListener("click", this.handleHeaderSearchInput);
  }
        ...
        <div className="overlay-content has-results m-t-20">
          ...
          <div className="container-fluid">
            ...
            <img
              ...
              src={process.env.PUBLIC_URL + "/assets/img/logo_2x.png"}
              alt="logo"
            ...
            <div className="search-results">
              ...
              <div className="row">
                <div className="col-md-6">
                  ...
                  <div className="d-flex m-t-15">
                    {/* BEGIN Search Result Item Thumbnail */}
                    <div className="thumbnail-wrapper d48 circular bg-success text-white inline ">
                      <div>T</div>
                    </div>
                    {/* END Search Result Item Thumbnail */}
                    <div className="p-l-10 inline p-t-5">
