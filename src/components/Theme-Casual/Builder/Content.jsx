...
const content = () => {
  ...
  return (
    <React.Fragment>
      {layoutOption[0] && (
        <div
          className={`page-content-wrapper content-builder content-builder-casual container ${
          ...
          <div className="content">
            <PageContainer>
              <ul className="breadcrumb p-l-0">
                ...
                <li className="breadcrumb-item active active-casual">
                  Plain template
                </li>
              </ul>
      ...
      {layoutOption[1] && (
        <div
          className={`page-content-wrapper content-builder content-builder-casual-sidebar container ${
            contentOptions[1] ? "active" : ""
          }`}
          id="plainContent"
        >
          <div
            className="secondary-sidebar secondary-sidebar-casual light"
      ...
      {contentOptions[1] && (
        <div
          className={`page-content-wrapper content-builder content-builder-casual ${
            contentOptions[1] ? "active" : ""
          }`}
      ...
      {contentOptions[2] && (
        <div
          className={`page-content-wrapper content-builder content-builder-casual full-height ${
          ...
          <div className="tab-content m-b-30 p-l-30">
            ...
            >
              <div className="scroll-wrapper " style={{ position: "relative" }}>
                ...
                >
                  <div className="p-l-30 p-r-50 p-t-50">
