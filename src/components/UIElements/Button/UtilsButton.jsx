...
const Component = (props) => {
    ...
    //dropdown button
    if(props.dropdowntoggle !== undefined && props.dropdowntoggle === "true") 
        buttonType = ` dropdown-toggle`
    else 
        buttonType = ` btn-${props.type}`

    return (
        <button aria-label={props.arialabel} type="button" className={`btn ${buttonType} ${classStyle} ${props.utilclass}`} {...props}>
            {props.children}
        </button>
    )
}
