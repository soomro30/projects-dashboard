...
const content = () => {
  ...
  const [layoutOption, setLayoutOption] = useState([false, false]);
  ...
  const setLayoutOptionTwo = (shouldAdd) => {
    shouldAdd
      ...
      : document.body.classList.remove("menu-behind");
  };
  ...
  return (
    <React.Fragment>
      ...
      {contentOptions[1] && (
        <div
          className={`page-content-wrapper content-builder ${
          ...
          <div className="tab-content m-b-30 p-l-30">
            ...
            >
              <div className="scroll-wrapper " style={{ position: "relative" }}>
                ...
                >
                  <div className="p-l-20 p-r-50 p-t-20">
                    ...
                    <div className="row p-b-35">
                      <div className="col-6 layout-block">
                        <Layout
                          ...
                          description={
                            "Divided Header & Condensed / Quick Menu"
                          }
                          onClick={() => {
            ...
            >
              <PerfectScrollbar
                className="p-l-10 p-r-50 m-t-30 p-t-20"
                style={{ paddingBottom: "10%" }}
              >
                <h5 className="semi-bold">Content</h5>
                <p className=" hint-text no-margin">Builder make it easier</p>
                <p className="small hint-text m-b-20">
                  Customize and Preview your dashboard.
                </p>
                <ul className="p-b-50">
                  <li className="full-width m-b-30">
                    ...
                    >
                      <img
                        ...
                        src={
                          process.env.PUBLIC_URL + "/assets/img/demo/blank.svg"
                        }
                      />{" "}
                      Plain
                    </Content>
                  ...
                  <li className="full-width m-b-30">
                    ...
                    >
                      <img
                        ...
                        className="m-b-10 image-responsive-height"
                        src={
                          process.env.PUBLIC_URL + "/assets/img/demo/3_9.svg"
                        }
                      />{" "}
                      Column view (3 : 9)
                    </Content>
                  ...
                  <li className="full-width m-b-30">
                    ...
                    >
                      <img
                        ...
                        className="m-b-10 image-responsive-height"
                        src={
                          process.env.PUBLIC_URL + "/assets/img/demo/9_3.svg"
                        }
                      />{" "}
                      Column view (9 : 3)
                    </Content>
                  ...
                  <li className="full-width m-b-30">
                    ...
                    >
                      <img
                        ...
                        className="m-b-10 image-responsive-height"
                        src={
                          process.env.PUBLIC_URL + "/assets/img/demo/6_6.svg"
                        }
                      />{" "}
                      Column view (6 : 6)
                    </Content>
